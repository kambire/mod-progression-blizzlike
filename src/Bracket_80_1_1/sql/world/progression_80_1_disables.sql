...
-- If your server starts progression directly in WotLK brackets (without applying Bracket_0 baseline disables),
-- future content like ICC/ToC/RS may be accessible because the world DB may not contain the required `disables` rows.
-- We enforce the lock here, at the beginning of WotLK.
-- - ICC raid + ICC 5-mans
-- - ToC raid + ToC 5-man
-- - Onyxia (reworked)
-- - Ruby Sanctum
